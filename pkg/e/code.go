...
const (
	...
	SuccessWithFindStartedTestChallenge = 20020 // 成功找到已经开启的题目测试容器
	SuccessWithEndTestChallenge         = 20021 // 成功删除题目测试容器
	SuccessWithRemoveChallenge          = 20022 // 成功删除题目
	...
	InvalidWithContainerInfoLost        = 40032 // 容器信息丢失
	InvalidWithNotExistStartedContainer = 40033 // 不存在已开启的容器
	InvalidWithRemoveChallenge          = 40034 // 删除题目失败
